...
class TestPageWebsite(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PageWebsite:
        """Test PageWebsite
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PageWebsite`
        """
        model = PageWebsite()
        if include_optional:
            return PageWebsite(
                first = '',
                items = [
                    manager_client.models.website.Website(
                        url = '', )
                    ],
                last = '',
                next = '',
