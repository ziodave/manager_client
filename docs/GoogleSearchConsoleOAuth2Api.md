# manager_client.GoogleSearchConsoleOAuth2Api
...
async with manager_client.ApiClient(configuration) as api_client:
    ...
    api_instance = manager_client.GoogleSearchConsoleOAuth2Api(api_client)
    exchange_auth_code_request = manager_client.ExchangeAuthCodeRequest() # ExchangeAuthCodeRequest | 
...
async with manager_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = manager_client.GoogleSearchConsoleOAuth2Api(api_client)
    build_authorize_uri_request = manager_client.BuildAuthorizeUriRequest() # BuildAuthorizeUriRequest | 
