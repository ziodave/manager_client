...
async with manager_client.ApiClient(configuration) as api_client:
    ...
    api_instance = manager_client.AccountsApi(api_client)
    id = 56 # int | 
...
async with manager_client.ApiClient(configuration) as api_client:
    ...
    api_instance = manager_client.AccountsApi(api_client)
    id = 56 # int | 
    update_account_request = manager_client.UpdateAccountRequest() # UpdateAccountRequest | 
