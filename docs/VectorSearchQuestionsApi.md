# manager_client.VectorSearchQuestionsApi
...
async with manager_client.ApiClient(configuration) as api_client:
    ...
    api_instance = manager_client.VectorSearchQuestionsApi(api_client)
    vector_search_question_request = manager_client.VectorSearchQuestionRequest() # VectorSearchQuestionRequest | 
