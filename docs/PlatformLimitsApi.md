# manager_client.PlatformLimitsApi
...
async with manager_client.ApiClient(configuration) as api_client:
    ...
    api_instance = manager_client.PlatformLimitsApi(api_client)
    platform_limit_request = manager_client.PlatformLimitRequest() # PlatformLimitRequest | 
