# manager_client.CustomDomainsApi
...
async with manager_client.ApiClient(configuration) as api_client:
    ...
    api_instance = manager_client.CustomDomainsApi(api_client)
    domain_validation_request = manager_client.DomainValidationRequest() # DomainValidationRequest | 
