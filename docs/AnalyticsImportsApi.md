# manager_client.AnalyticsImportsApi
...
async with manager_client.ApiClient(configuration) as api_client:
    ...
    api_instance = manager_client.AnalyticsImportsApi(api_client)
    analytics_import_request = manager_client.AnalyticsImportRequest() # AnalyticsImportRequest | 
