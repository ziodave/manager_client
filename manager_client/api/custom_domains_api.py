...
class CustomDomainsApi:
    ...
    async def validate(
        self,
        domain_validation_request: DomainValidationRequest,
        ...
        :param domain_validation_request: (required)
        :type domain_validation_request: DomainValidationRequest
        ...
        _param = self._validate_serialize(
            domain_validation_request=domain_validation_request,
    ...
    def _validate_serialize(
        ...
        if domain_validation_request is not None:
            _body_params = domain_validation_request
